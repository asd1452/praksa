...
import { Tab, List, Label, Grid, Image, Icon, Popup, Card, Rating, Container, Header, Button } from 'semantic-ui-react'
...
class About1 extends Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:8000/admin/api/filler`)
      .then(res => {
        const podaci = res.data;
        this.setState({ tekst: podaci[0] });
      })
  }
  ...
  render() {
    return (
      ...
      {this.state.tekst.sadrzaj}</Container>
